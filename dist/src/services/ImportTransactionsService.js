...
var csv_parse_1 = __importDefault(require("csv-parse")); //manipular o arquivo csv
var fs_1 = __importDefault(require("fs")); //File System ajuda abrir, ler o arquivo csv
...
var ImportTransactionsService = /** @class */ (function () {
    ...
    ImportTransactionsService.prototype.execute = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            var categoriesRepository, transactionsRepository, contactsReadStream, parsers, parseCSV, categories, transactions, existemtCategories, existemtCategoriesTitles, addCategoryTitles, newCategories, finalCategories, createdTransactions;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        existemtCategories = _a.sent();
                        existemtCategoriesTitles = existemtCategories.map(function (category) { return category.title; });
                        addCategoryTitles = categories
                            .filter(function (category) { return !existemtCategoriesTitles.includes(category); })
                    ...
                    case 3:
                        _a.sent();
                        finalCategories = __spreadArrays(newCategories, existemtCategories);
